    ...
    def user_inputs(cls, tea_lca=False, prod_type=None):
        tea_only_inputs1 =[
            ...
            OptionsInput(
                ...
                tooltip=Tooltip(
                    'As a carbon mitigation technology, a CCS unit captures CO2 from a manufacturing plant and transports the captured CO2 to a sequestration site for long-term storage.',
                )
...
#Read Data
    ...
    def get_cost_breakdown(self):
        ...
        if hasattr(self,'effic_SMR') and self.lca_pathway is None:
            self.effic_SMR = self.effic_SMR/100 # converting % to fraction
