...
countries = [
    'China', 'India', 'Korea', 'United_States', 'Canada', 'Austria', 'Belgium', 'Bulgaria', 'Croatia','Cyprus',
    'Czechia', 'Denmark', 'EU_27', 'EU27+1', 'Estonia', 'Finland', 'France', 'Germany', 'Greece','Hungary',
...
elec_countires_year_co2 = pd.read_csv(csv_path, usecols=['Year'] + countries)
#print(elec_countires_year_co2)

def elec_co2(country='India'):
    years = elec_countires_year_co2['Year']
    co2_elec = elec_countires_year_co2[country.title()]  #tonne CO2/GJ
